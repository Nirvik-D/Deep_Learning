# -*- coding: utf-8 -*-
"""
Created on Fri Jan 23 13:28:46 2015
...
""" Start executing the HMC_Sampler from here """

# Please note that the below function is not a part of the Hybrid Monte Carlo Module.
# It's actually used to generate a multi-variate Gaussian distirbution to use
# the HMC_Sampler on.
# User may use the below function inside the main function if a multi-variate 
...
def sampler_on_nd_gaussian(sampler_cls, burnin, n_samples, dim=10):
    ...
    cov_inv = numpy.linalg.inv(cov) # Original code didn't use the numpy.linalg.
                                    # Used in edited code later.
